...
Within IIS, I registered the PHP folder created earlier. Once completed, I restarted IIS. Next I downloaded OSticket from the installation files and extracted and copied the uploaad files to wwwroot. Then I ran Osticket.
<p>
